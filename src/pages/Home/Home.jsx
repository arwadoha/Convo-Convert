  ...
  /* 
    {
      ...
      nertext: "sdofkdspfokdspfokdspfoksdpfoksdfpoksdfp",
      nerTags: [
        {
        ner: "palestine",
        type: "PLACE"
...
*/
    ...
    },
    {
        ...
        CustomerName: "Mohammed Ali",
        audioText:
            "و المرحبة. أهلا أهلا أهلا أستاذي. أعتذر منك فصلة المكالمة. هلا أستاذي سوف نرفع موضوع حضرتك للاتصالات سيبعث لك خط النفاذ لأنه عندك أستاذة قرأتها تطلع وتنزل بنفس الوقت. تمام لأنه ما أفتح عندك مجال الاتصالات فهذا اسمح لي أنت أي أستاذ. إذا برنامج من عنده أول ",
        date: "May5",
        isStared: false,
        status: "notsolved",
    },
    {
        ...
        CustomerName: "Mohammed Ali",
        audioText:
            "بعد. مرحبا أسمع. تفضل. مرحبا يعطيك العافية. الله يعطيك رب حليم. الرقم أربعة ثمانية سبعة اثنين ثلاثة. كانت عندي مشكلة في الإنترنت بالاتصال شركة الاتصالات وحدث أن المودم في مشكلة. أعجبنا من جديد البرمجية الرقم اسم بيان النتشة. بيان محمد شكري النتشة نعم بيان",
        date: "May1",
        isStared: true,
        status: "solved",
    },
    {
        ...
        CustomerName: "Mohammed Ali",
        audioText:
            " ببعد مرحبا تفضل أهلا مرحبا يا هلا عندي استفسار أنا عليك كيكا طابعة. طابعات. مقوي. برمجة. مقوي. مقوي. برمجة. هو منبر من ليس له علاقة في مضاعفة السرعة. يعني لا لا لا أنا عارف أنه ليس هو لكن أنا رفعت النتيجة فلما جاءت عندي على التلفزيون على التلفزيون شو اسمه",
        date: "May1",
        isStared: false,
        status: "notsolved",
    },
    {
        ...
        CustomerName: "Mohammed Ali",
        audioText:
            "مدى. مرحبا شهاب معك. تفضل. يعطيك العافية. الله يعافيك. هلا من حوالي الساعة ساعة ونص كنت أحاول منكم ما كنش في رد يا أستاذ في مشكلة عامة في منطقتكم ومنطقة نابلس يعني فكل الناس ترن يعني خلص أنا في مشكلة يا سيدي قلت مع مبيعاتنا والله أحاول أتصل وبعثت رسالة عل",
        date: "Apr9",
        isStared: true,
        status: "solved",
    },
    {
        ...
        CustomerName: "Mohammed Ali",
        audioText:
            "  سلام عليكم ستاذ تفضل  كيف بقدر اساعدك مرحبا وعليكم السلام النت عندي قاطع من اسبوع ",
        date: "Apr9",
        isStared: false,
        status: "notsolved",
    },
    {
        ...
        CustomerName: "Mohammed Ali",
        audioText:
            "   الو تفضل استاز  كيف بقدر اساعد حضرتك كيف بقدر اساعدك مرحبا النت عندي قاطع من اسبوع ",
        date: "Apr2",
        isStared: false,
        status: "solved",
    },
    {
        ...
        CustomerName: "Mohammed Ali",
        audioText:
            " ألو المرحبة. أهلين أهلا أستاذ. تحكي معك ألاء من شركة مدى لخدمات الإنترنت. أهلا. أهلا أستاذ. أحكي لكم السيدة رامي غزال تأخير أستاذة. أحدثكم عن مشكل الإنترنت صحيح فوصل كل قليل أفصل وبرجع تمام خليني أساعدك أستاذة عندك ساعة أمامك ما فاصل أستاذ أول ضع يدك اليم",
        date: "Apr1",
        isStared: true,
        status: "notsolved",
    },
                ...
                {fackMessages.map((message) => {
                    return (
                        <div key={message.id} className="message">
                            <Link to={`/message-details/${message.id}`} className="employee">
                                {message.employeeName}
                            </Link>

                            <Link to={`/message-details/${message.id}`} className="customer">
